    ...
    <Container maxW="5xl" px={{ base: 6, md: 3 }} py={10}>
      <Stack direction={{ base: "column-reverse", md: "row" }}>
        <Stack direction="column" spacing={6}>
          ...
          >
            I'll build a quality website for you.
          </Heading>
          <Text
          ...
          >
            Whether you need a website for your business, blog, or portfolio, I
            can help you. I am capable of building full-stack web applications
            with multiple technologies, including React, Node.js, Next.js,
            Laravel and more.
          </Text>
          <HStack spacing={3}>
            <Button
        ...
        <Box ml={{ base: 0, md: 5 }}>
          <Image
            ...
            objectFit="cover"
            src="https://img.freepik.com/free-vector/web-design-production-maintenance-websites-web-graphic-interface-design-responsive-website-software-engineering-development-colorful-icon_335657-345.jpg?w=2000"
            rounded="md"
            fallback={<Skeleton />}
          />
        </Box>
